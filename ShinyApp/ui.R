    ...
    tabItems(
                ...
                column(4, 
                       box(width = 12, height = 600, collapsible = TRUE, collapsed = TRUE,
                           ...
                           fluidRow( 
                             ...
                             # joy of continuous learning --> Book Less bad programming
      ...
      tabItem("Output", #h2("Results based on Gerbier et al. 2021"),
              ...
              fluidRow(
                ...
                column(3,  #helpText("Choose top N prescribed drug agents."),
                    # sliderInput("top",
                    #             "Top N:",
                    #             min = 1,
                    #             max = 33,
                ...
                column(6, plotlyOutput("barPlot1")
                )
              ),
             ...
             fluidRow(
                ...
                column(6, plotlyOutput("barPlot2")
